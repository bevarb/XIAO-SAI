...
if __name__ == "__main__":
    ...
    path = [0, 17,19,26,25,18, 20,  1,  2, 12, 8,  9, 7, 6, 14, 11, 15, 27, 16, 13, 10, 5,  3, 4, 22, 28, 24, 23, 21, 29,0]
    # path = [0, 2, 1, 9, 8, 12, 15, 27, 16, 13, 10, 5, 3, 4, 21, 23, 22, 28, 25, 24, 14, 11, 6, 7, 18, 26, 29, 19, 20, 17, 0]
    Total = 0
